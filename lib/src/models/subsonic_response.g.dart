...
Map<String, dynamic> _$$SubsonicResponseImplToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.musicFolders case final value?) 'musicFolders': value,
      if (instance.indexes case final value?) 'indexes': value,
      if (instance.directory case final value?) 'directory': value,
      ...
      if (instance.videoInfo case final value?) 'videoInfo': value,
      if (instance.nowPlaying case final value?) 'nowPlaying': value,
      if (instance.searchResult case final value?) 'searchResult': value,
      if (instance.searchResult2 case final value?) 'searchResult2': value,
      if (instance.searchResult3 case final value?) 'searchResult3': value,
      if (instance.playlists case final value?) 'playlists': value,
      if (instance.playlist case final value?) 'playlist': value,
      if (instance.jukeboxStatus case final value?) 'jukeboxStatus': value,
      if (instance.jukeboxPlaylist case final value?) 'jukeboxPlaylist': value,
      if (instance.license case final value?) 'license': value,
      if (instance.users case final value?) 'users': value,
      if (instance.user case final value?) 'user': value,
      if (instance.chatMessages case final value?) 'chatMessages': value,
      if (instance.albumList case final value?) 'albumList': value,
      if (instance.albumList2 case final value?) 'albumList2': value,
      if (instance.randomSongs case final value?) 'randomSongs': value,
      if (instance.songsByGenre case final value?) 'songsByGenre': value,
      if (instance.lyrics case final value?) 'lyrics': value,
      if (instance.podcasts case final value?) 'podcasts': value,
      if (instance.newestPodcasts case final value?) 'newestPodcasts': value,
      if (instance.internetRadioStations case final value?)
        'internetRadioStations': value,
      if (instance.bookmarks case final value?) 'bookmarks': value,
      if (instance.playQueue case final value?) 'playQueue': value,
      if (instance.shares case final value?) 'shares': value,
      if (instance.starred case final value?) 'starred': value,
      if (instance.starred2 case final value?) 'starred2': value,
      if (instance.albumInfo case final value?) 'albumInfo': value,
      if (instance.artistInfo case final value?) 'artistInfo': value,
      if (instance.artistInfo2 case final value?) 'artistInfo2': value,
      if (instance.similarSongs case final value?) 'similarSongs': value,
      if (instance.similarSongs2 case final value?) 'similarSongs2': value,
      if (instance.topSongs case final value?) 'topSongs': value,
